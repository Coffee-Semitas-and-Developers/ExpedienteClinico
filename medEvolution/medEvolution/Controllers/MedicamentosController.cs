...
namespace medEvolution.Controllers
{
    public class MedicamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodigoMedicamento,NombreMedicamento")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodigoMedicamento,NombreMedicamento")] Medicamento medicamento)
        {
            if (ModelState.IsValid)
            {
